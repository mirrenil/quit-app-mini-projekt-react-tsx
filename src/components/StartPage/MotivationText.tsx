    ...
    useEffect(() => {
      ...
      .then(data => {
        ...
        if(temp < 0) {
          ...
          setMessage('Do you what is much better than smokin? swiming! its a hot day, try going to the beach')
        }
      })
    }, []);
  ...
  return (
    <div className="motivation-container">
      ...
      <p className="motivation-body-style">
        Smoking shortens life by about <span>10</span> years and costs about <span>10 000:-</span> annuarly.
        Dont hesitate, live a longer and richer life by stoping today.
      </p>
